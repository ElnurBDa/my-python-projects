...
info_xolst.create_text(100, 200, text="Calculator_v5\nСоздан Бадаловым Эльнуром\n31.08.2019", fill="yellow")
# xolst ...
xolst.create_text(200, 10, text="Калькулятор" )
#надписи-указатели
label_za_otvetom = Label(w1, bg="#997" , width=50, height=3)
...
btn = Button(w1, text="+", width=7, bg="#998")
...
def funk_plus(a ,b ):
    ...
    label_otvet = Label(w1, text="Ответ:    " + str(result), bg="#997", width=30, height=3)
...
def funk_sin(a,b):
    ...
    label_otvet_1= Label(w1, text="Ответ первого:    " + str(result), bg="#997", width=30, height=1)
    label_otvet_1.place(x=100, y=50)
    result = math.sin(float(b))
    label_otvet_2 = Label(w1, text="Ответ второго:    " + str(result), bg="#997", width=30, height=1)
...
def funk_factorial(a,b):
    ...
    label_otvet_1 = Label(w1, text="Ответ первого:    " + str(result), bg="#997", width=50, height=1)
    label_otvet_1.place(x=20, y=50)
    result = math.factorial(float(b))
    label_otvet_2 = Label(w1, text="Ответ второго:    " + str(result), bg="#997", width=50, height=1)
